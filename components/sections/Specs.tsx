...
export default function Specs() {
    const [activeCategory, setActiveCategory] = useState<string>(specsCategories[0].id);
            ...
            <div className="section-container relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Every detail crafted with precision. Premium European materials and cutting-edge systems.
                    </p>
                </div>

                {/* Category Navigation - Premium tabs */}
                <div className="flex flex-wrap justify-center gap-3 mb-12">
                    {specsCategories.map((category) => (
                        <button
                            key={category.id}
                                    ...
                                    <div className="max-w-4xl mx-auto">
                                            ...
                                            <div className="flex items-start gap-6 mb-8">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-gray-500">
                                                        Premium specifications for lasting quality
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        >
                                            ...
                                            <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 rounded-2xl p-4 text-center backdrop-blur-sm border border-secondary/10">
                                                ...
                                                <div className="text-xs text-gray-600">Energy Rating</div>
                                            </div>
                                            <div className="bg-gradient-to-br from-accent/10 to-accent/5 rounded-2xl p-4 text-center backdrop-blur-sm border border-accent/10">
                                                ...
                                                <div className="text-xs text-gray-600">Quality Materials</div>
                                            </div>
                                        </motion.div>
                                    </div>
                                </motion.div>
                ...
                <div className="text-center mt-16">
                    <div className="inline-flex flex-col items-center gap-4 bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-gray-100 shadow-lg">
                        <p className="text-gray-600">Want the complete technical documentation?</p>
