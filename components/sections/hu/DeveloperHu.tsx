...
import { developerStatsHu, qualityPromisesHu, uiTextsHu } from '@/lib/data-hu';
                ...
                >
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                            {developerStatsHu.map((stat, index) => (
                        ...
                        <div className="bg-white/5 rounded-2xl p-6">
                            <h3 className="font-bold text-lg mb-4">{t.promise}</h3>
                            <ul className="space-y-3">
                                {qualityPromisesHu.map((promise, index) => (
                    ...
                    <motion.div variants={itemVariants} className="relative">
                        <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 aspect-square flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-bold mb-2">Kivitelezői portfólió</h3>
                                <p className="text-white/60 mb-4">
                                    Átadott projektek és építési minőség
                                </p>
                        ...
                        <div className="absolute -bottom-4 -right-4 bg-secondary text-white px-6 py-3 rounded-xl shadow-lg">
                            ...
                            <div className="text-sm">Projekt</div>
                        </div>
                    </motion.div>
                </motion.div>
            </div>
