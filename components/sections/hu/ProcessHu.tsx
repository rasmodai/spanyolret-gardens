...
import { processStepsHu, processReassuranceHu, uiTextsHu } from '@/lib/data-hu';
            ...
            <div className="section-container relative z-10">
                ...
                >
                    ...
                    <ul className="grid md:grid-cols-2 gap-3">
                        {processReassuranceHu.map((point, index) => (
